...
const Logo = () => {
  ...
  return (
    <div className='py-20 lg:px-12 flex flex-col gap-20'>
        <h1 className="font-semibold font-helvetica text-white-1 text-end max-sm:text-[35px] max-lg:text-[40px] max-lg:text-center lg:text-[45px] xl:text-[60px]"><span className="text-red-1">RED</span>WOOD PRODUCT</h1>
