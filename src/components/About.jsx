  ...
  return (
    <div className="py-20 flex max-lg:flex-col max-lg:gap-8">
        ...
        <div className="flex-1 flex flex-col gap-9">
            <h1 className="font-semibold font-helvetica text-white-1 max-lg:text-[40px] max-lg:text-center lg:text-[45px] xl:text-[60px]">ABOUT <span className="text-red-1">RED</span>WOOD</h1>
