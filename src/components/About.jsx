...
const About = () => {
  return (
    <div className="py-20 flex max-lg:flex-col max-lg:gap-8">
        <div data-aos="fade-down" data-aos-duration="1000" className="w-full lg:w-[45vw] flex justify-center items-center ">
            <img src={HeroBox} alt="About Image" width={450} height={450} className="aspect-square max-lg:w-[300px] max-lg:h-[300px]"/>
        </div>
        <div data-aos="fade-up" data-aos-duration="1000" className="flex-1 flex flex-col gap-9 ">
